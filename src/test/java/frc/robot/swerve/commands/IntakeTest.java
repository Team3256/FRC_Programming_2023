...
public class IntakeTest {
  ...
  public void TestTeleopX() {
    ...
    CommandScheduler.getInstance()
        .schedule(new TeleopSwerveFieldOriented(swerveDrive, leftX, leftY, rotation));
    //        runScheduler(1);
  ...
  public void TestTeleopY() {
    ...
    DoubleSupplier leftY = () -> 0.9 * Constants.SwerveConstants.MAX_VELOCITY_METERS_PER_SECOND,
        leftX = () -> 0.0,
        rotation = () -> 0.0;
