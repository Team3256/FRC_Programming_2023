...
public final class Constants {
  ...
  public static final double kStickDeadband = 0.10;
  ...
  public static final class FieldConstants {
    ...
    public static final class Community {
      ...
      public static final double kChargingStationInnerX = kChargingStationOuterX - kChargingStationLength;
      public static final double kChargingStationLeftY = kMidY - kTapeWidth;
      public static final double kChargingStationRightY = kChargingStationLeftY - kChargingStationWidth;
      public static final Translation2d[] kChargingStationCorners = new Translation2d[] {
