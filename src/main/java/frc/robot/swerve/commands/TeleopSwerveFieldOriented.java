...
public class TeleopSwerveFieldOriented extends CommandBase {
  ...
  public TeleopSwerveFieldOriented(
  ...
  public TeleopSwerveFieldOriented(
      SwerveDrive drivetrainSubsystem) { // constructor that sets values to 0
    this.drivetrainSubsystem = drivetrainSubsystem;
  ...
  public void execute() {
    ...
    drivetrainSubsystem.drive(translation, rotationSupplier.getAsDouble(), true, true);
  }

  @Override
  public void end(boolean interrupted) {
    Translation2d translation = new Translation2d(0, 0);
    drivetrainSubsystem.drive(translation, 0, true, true);
  }
}
