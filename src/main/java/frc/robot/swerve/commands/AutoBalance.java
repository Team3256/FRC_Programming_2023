...
import static frc.robot.swerve.SwerveConstants.kChargeStationTiltThreshold;
...
public class AutoBalance extends CommandBase {
  ...
  public boolean isFinished() {
    return Math.abs(swerveDrive.gyro.getPitch()) <= kChargeStationTiltThreshold.getDegrees();
  }
}
