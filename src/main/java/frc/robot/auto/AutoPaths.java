...
public class AutoPaths {
  ...
  public void sendCommandsToChooser() {
    ...
    AutoChooser.addIncrementalPaths(scorePreload.get(), "Node8x3-Engage", node8x3Engage);
    ...
    ArrayList<Command> node2x3Engage =
        autoBuilder.createPaths(
            ...
            kDefaultPathConstraints,
            kEngagePathConstraints);
    AutoChooser.addIncrementalPaths(scorePreload.get(), "Node2x3-Engage", node2x3Engage);
