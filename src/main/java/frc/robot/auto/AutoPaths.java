...
public class AutoPaths {
  ...
  public void sendCommandsToChooser() {
     ...
     *
     * // Node8x2-Engage
     * ArrayList<Command> node8x2Engage = autoBuilder.createPaths("Node8x2-Engage",
     * kDefaultPathConstraints,
     * kEngagePathConstraints);
     * AutoChooser.addIncrementalPaths(scorePreload.get(), "Node8x2-Engage",
     * node8x2Engage);
     *
     * // Node2x2-Engage
     * ArrayList<Command> node2x2Engage = autoBuilder.createPaths("Node2x2-Engage",
     * kDefaultPathConstraints,
     * kEngagePathConstraints);
     * AutoChooser.addIncrementalPaths(scorePreload.get(), "Node2x2-Engage",
     * node2x2Engage);
     *
     * // Node2-Preload-Ready
     ...
     *
     * // Node8x2-Ready
     * ArrayList<Command> node8x2Ready = autoBuilder.createPaths("Node8x2-Ready",
     * kDefaultPathConstraints);
     * AutoChooser.addIncrementalPaths(scorePreload.get(), "Node8x2-Ready",
     * node8x2Ready);
     *
     * // Node2x3-Engage
