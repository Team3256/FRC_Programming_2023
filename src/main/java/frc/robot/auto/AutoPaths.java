...
public class AutoPaths {
  ...
  public void sendCommandsToChooser() {
    ...
    AutoChooser.addPathGroup(
        scorePreload.get(), "Node5-Engage", node5Engage, new LockSwerve(swerveSubsystem));
    ...
    AutoChooser.addPathGroup(
        scorePreload.get(), "Node2x2-Engage", node2x2Engage, new LockSwerve(swerveSubsystem));
    ...
    ArrayList<Command> node8x3Engage = autoBuilder.createPaths(
        ...
        kFastPathConstraints,
        kEngagePathConstraints);
    AutoChooser.addPathGroup(scorePreload.get(), "Node8x3-Engage",
        node8x3Engage);
    ...
    ArrayList<Command> node2x3Engage = autoBuilder.createPaths(
        ...
        kFastPathConstraints,
        kEngagePathConstraints);
    AutoChooser.addPathGroup(scorePreload.get(), "Node2x3-Engage",
        node2x3Engage);
