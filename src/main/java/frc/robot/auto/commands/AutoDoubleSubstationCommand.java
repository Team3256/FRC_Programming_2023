...
public class AutoDoubleSubstationCommand extends CommandBase {
    ...
    public AutoDoubleSubstationCommand(SwerveDrive swerveSubsystem, Elevator elevatorSubsystem, ArmSubsystem armSubsystem, Intake intakeSubsystem, LED ledSubsystem) {
    ...
    public void initialize() {
        ...
        waypoints.add(new PathPoint(swerveSubsystem.getPose().getTranslation(), swerveSubsystem.getPose().getRotation()));
        waypoints.add(new PathPoint(new Translation2d(14.25,6.03),new Rotation2d(180)));

        PathPlannerTrajectory trajectory = PathPlanner.generatePath(new PathConstraints(5,5),waypoints);
        ...
        new SequentialCommandGroup(
                ...
                autoBuilder.createCommand(trajectory),
