...
public final class DynamicPathGenerationConstants {
  ...
  public static final double searchLowX = 1.87;
  public static final double searchLowY = 0.50;
  public static final double searchResX = 0.2;
  public static final double searchResY = 0.2;
  public static final double searchHiX = 11.20;
  public static final double searchHiY = 4.83;
