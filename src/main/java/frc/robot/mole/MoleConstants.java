...
public final class MoleConstants {
  ...
  public static Rotation2d kCubeMidRotation = Rotation2d.fromDegrees(25);
  public static Rotation2d kCubeHighRotation = Rotation2d.fromDegrees(45);

  public static Rotation2d kMolePivotAngleTolerance = Rotation2d.fromDegrees(10);
}
